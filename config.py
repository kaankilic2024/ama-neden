...
KANAL_ADI = "Ama Neden?"
KANAL_TANIMI = (
    "Yetiskinler icin merak kanali. Her video tek bir soruya cevap verir: "
    "neden boyle? Konular farkli alanlardan gelir (uzay, doga, cografya, "
    "teknoloji, is dunyasi) ama hepsi ayni seyi yapar: gunluk hayatta fark "
    "edilmeyen bir seyi alip 'aslinda neden oyle' diye acikla. "
    "Ton merakli ve anlasilir; ders verir gibi degil, ilginc bir sey kesfetmis "
    "bir arkadas gibi. Her video izleyiciye 'hic dusunmemistim' dedirtmeyi "
    "hedefler."
)

# TEMA ROTASYONU
# Her gun farkli bir alandan konu secilir; boylece cesitlilik olur ama
# hepsi ayni "neden" sorusuna cevap verdigi icin kitle tutarli kalir.
# Haftanin gunune gore secilir (0=Pazartesi).
TEMALAR = {
    0: ("uzay", "uzay, gezegenler, yildizlar, evren"),
    1: ("doga", "hayvanlar, bitkiler, doga olaylari"),
    2: ("cografya", "ulkeler, sehirler, iklim, yeryuzu sekilleri"),
    3: ("teknoloji", "gunluk nesneler, makineler, nasil calisir"),
    4: ("cokus", "batan sirketler, biten donemler, kaybolan seyler"),
    5: ("insan", "vucut, beyin, davranis, aliskanliklar"),
    6: ("karisik", "tum alanlardan serbest secim"),
}

# Gorsellerin ortak stili (Ingilizce)
GORSEL_STIL = (
    "high quality digital illustration, clean modern style, "
    "cinematic composition, dramatic lighting, rich colors, "
    "clear focal subject, depth of field, "
...
VIDEO_TIPLERI = {
    "shorts": {
        ...
        "konu_tipleri": [
            "neden boyle sorusu",
            "fark edilmeyen bir detayin sebebi",
            "yaygin bir yanlis bilginin duzeltilmesi",
            "gunluk bir nesnenin arkasindaki sebep",
            "sasirtici bir 'aslinda' bilgisi",
        ],
    ...
    "uzun": {
        ...
        "konu_tipleri": [
            "bir seyin neden oyle oldugunun detayli aciklamasi",
            "bir sistemin nasil calistigi",
            "bir seyin neden bittigi veya coktugu",
            "yaygin bir inanisin arkasindaki gercek",
            "bir olgunun zincirleme sebepleri",
            "iki sey arasindaki beklenmedik baglanti",
        ],
    },
}
...
GEMINI_SESI = os.getenv("GEMINI_SESI", "Kore")
...
GEMINI_SES_YONERGE = (
    "Asagidaki metni Turkce olarak, merakli ve samimi bir tonla oku. "
    "Ilginc bir sey kesfetmis de anlatiyormus gibi. Ders verir gibi degil, "
    "sohbet eder gibi. Sorulari gercekten merak ediyormus gibi vurgula. "
...
SES_TONU = os.getenv("SES_TONU", "sohbet")
...
SFX_TIPI = os.getenv("SFX_TIPI", "pop")
